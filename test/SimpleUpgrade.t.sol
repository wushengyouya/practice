...
contract SimpleUpgradeTest is Test {
    ...
    function test_old() public {
        vm.prank(address(1));
        (bool success,) = address(simple).call(abi.encodeWithSignature("foo()"));
    ...
    function test_upgradeNew() public {
        ...
        vm.prank(address(1));
        (bool success2,) = address(simple).call(abi.encodeWithSignature("foo()"));
    ...
    function test_upgrade2() public {
        ...
        address(logic1).call(abi.encodeWithSignature("upgrade2(address)", address(logic2)));
