...
contract NFTSwap is IERC721Receiver {
    ...
    function list(address nftAddr, uint256 tokenId, uint256 price) public CheckNftAddr(nftAddr) {
    ...
    //购买
    function purchase(address nftAddr, uint256 tokenId) public payable CheckNftAddr(nftAddr) {
    ...
    //撤回nft订单
    function revoke(address nftAddr, uint256 tokenId) public CheckNftAddr(nftAddr) {
        IERC721 nft = IERC721(nftAddr);
    ...
    function update(address nftAddr, uint256 tokenId, uint256 newPrice) public CheckNftAddr(nftAddr) {
        //价格必须大于0
